...
simulate.removed.loops.diffusion <- function(j, p.infection, pct.starting.infected, n, threshold, runs = 10000, master_data =
                                               fread("removed_loops/output/removed_loops_measures.csv")[,2:5]){
  # load in network
