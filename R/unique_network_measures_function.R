...
#' @export
#' @import data.table
compute.measures <- function(igraph.network, i, data = fread("unique_edges/output/unique_edges_table.csv")){
  ID <- i
...
#' @export
#' @import data.table
append.measures <- function(measures, i, path = "unique_edges/output/unique_edges_measures.csv"){
  if (i == 1){
...
#' @export
#' @import data.table
unique.network.measures <- function(network, i, path = "unique_edges/output/unique_edges_measures.csv"){
